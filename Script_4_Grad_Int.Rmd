...
```{r SNR_plot_hap, results = "asis", fig.height = 8, eval = FALSE}
...
```{r SNR_plot_hap_zoom, results = "asis", fig.height = 8, eval = FALSE}
...
```{r SNR_plot_ang, results = "asis", fig.height = 8, eval = FALSE}
...
```{r SNR_plot_ang_zoom, results = "asis", fig.height = 8, eval = FALSE}
...
```{r BCA_expr_resp_topo_hap, include = FALSE, eval = FALSE, results = "asis"}
...
```{r BCA_expr_resp_topo_ang, include = FALSE, eval = FALSE, results = "asis"}
